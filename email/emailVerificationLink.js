                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h4
                                                                    style="margin: 0; color: #ce416f; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 20px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">

                                                                    <a href="${link}"
                                                                        style="background-color: #ce416f;color:white;padding:10px 30px;text-decoration: none; border-radius: 50px;">VERIFY</a>
                                                                </h4>
