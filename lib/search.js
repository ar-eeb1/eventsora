...
import { PROVIDER_BOOKINGS_SHOW, PROVIDER_DASHBOARD, PROVIDER_LISTING_ADD, PROVIDER_LISTING_SHOW, PROVIDER_LISTING_VARIANT_ADD, PROVIDER_LISTING_VARIANT_SHOW, PROVIDER_MEDIA_SHOW } from "@/routes/ProviderPanelRoute";
...
export const searchProviderData = [
    ...
    },
    {
        ...
        description: "Manage listings variants",
        url: PROVIDER_LISTING_VARIANT_SHOW,
        keywords: ["listing variant", "variant"]
    },
    {
        label: "Add Listing Variant",
        description: "Add new listings variants",
        url: PROVIDER_LISTING_VARIANT_ADD,
        keywords: ["add listing variant", "new listing variant"]
    },
    //    {
    //        label: "Coupon",
